...
const (
	...
	FIDO2Error = 31
	// EH:
	// RestrictAccess means that an error was encountered while processing the "-restrict_access" flag,
	// such as an error reading the allowed path list or an invalid path in the list.
	RestrictAccess = 32
)
